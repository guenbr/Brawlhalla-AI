...
MONITOR = 2
CAPTURE_EVERY = 5  # seconds between each capture
TOTAL_DURATION = 60  # total seconds to run for
...
# grab an annotated debug frame every CAPTURE_EVERY seconds
...
# open a resizable window to step through captured frames
